  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update Brand Option</h5>
      ...
      <div class="modal-body">
        <form id="update_brand_form" onsubmit="return false">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="update_brand" id="update_brand" placeholder="Category Name">

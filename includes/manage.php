...
class Manage
{
	...
	private function pagination($con,$table,$pno,$n){
		...
		if ($last != 1) {
			...
			$pagination .= "<li class='page-item'><a class='page-link' href='#' pn='".$pageno."' style='color:#333;'> $pageno </a></li>";
			...
			if ($last > $pageno) {
				$next = $pageno + 1;
				$pagination .= "<li class='page-item'><a class='page-link' href='#' pn='".$next."' style='color:#333;'> Next </a></li>";
			}
		}
		//LIMIT 0,10
		//LIMIT 20,10
...
//echo $obj->deleteRecord("categories","cid",10);
//print_r($obj->getSingleRecord("categories","cid",1));
//echo $obj->update_record("categories",["cid"=>1],["parent_cat"=>0,"category_name"=>"New Electronics","status"=>1]);
